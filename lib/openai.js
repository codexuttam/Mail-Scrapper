...
// Validate environment on import so misconfigurations are visible early.
// If you intentionally want to run without OpenAI configured (e.g., tests),
// catch the error where you import this module.
env.checkEnv();
